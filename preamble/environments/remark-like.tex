...
\NewRemarkLikes{poznámka, příklad, úloha, paradox}
...
\let\proof\relax
\NewRemarkLike[numbered=no, qed=\proofqed, name={Důkaz}]{důkaz}
\NewRemarkLike[numbered=no, name={Jak vymyslet důkaz}]{jak vymyslet důkaz}
\NewRemarkLike[numbered=no, name={Náčrt Důkazu}, qed=\proofqed]{náčrt důkazu}
